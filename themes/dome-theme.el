...
(let ((c '((class color) (min-colors 89)))
  ...
  (let* ((bg             "#282c34")
         ...
         (search-rest-bg blue-d)
         (search-rest-fg white)
         ;; line number column
         (linum-bg       bg-d)
         (linum-hl-fg    "#BBBBBB")
         ;; mode line
    ...
    (custom-theme-set-faces
     ...
     ;; mode-line
     `(doom-modeline-buffer-path       ((,c (:foreground ,white :bold t))))
     `(doom-modeline-buffer-project    ((,c (:foreground ,fg))))
     `(doom-modeline-buffer-modified   ((,c (:foreground ,red))))
     `(doom-modeline-buffer-major-mode ((,c (:foreground ,white :bold t))))
     ...
     `(lazy-highlight         ((,c (:background ,search-rest-bg :foreground ,search-rest-fg))))
     `(match                  ((,c (:foreground ,green :background ,black :bold t))))
     `(trailing-whitespace    ((,c (:background ,doc-comments))))
     `(vertical-border        ((,c (:foreground ,vertical-bar :background ,vertical-bar))))
     `(show-paren-match       ((,c (:foreground ,red :background ,black :bold t))))
     `(show-paren-mismatch    ((,c (:foreground ,black :background ,red :bold t))))
     `(linum                  ((t  (:background ,linum-bg :foreground "#536166" :height 120 :weight light :underline nil :slant normal))))
     `(linum-relative-current-face      ((t (:inherit linum :foreground "#8299A1"))))
     `(nlinum-relative-current-face     ((t (:inherit linum :foreground "#8299A1"))))
     ...
     `(font-lock-doc-face               ((,c (:foreground ,doc-comments :inherit font-lock-comment-face))))
     ...
     `(font-lock-preprocessor-face           ((,c (:foreground ,operators :bold t))))
     ...
     `(diredp-dir-name             ((,c (:foreground ,white :bold t))))
     ...
     `(diredp-dir-heading          ((,c (:foreground ,blue :bold t))))
     ...
     `(diredp-rare-priv            ((,c (:foreground ,red :bold t))))
     `(diredp-dir-priv             ((,c (:foreground ,blue :bold t))))
     `(diredp-no-priv              ((,c (:foreground ,grey))))
     `(diredp-number               ((,c (:foreground ,magenta))))
     `(diredp-date-time            ((,c (:foreground ,blue))))

     ;; Search
     `(isearch                     ((,c (:background ,search-bg :foreground ,search-fg :bold t))))
     ...
     ;; ediff
     `(ediff-fine-diff-A    ((,c (:background ,grey-d :bold t))))
     `(ediff-fine-diff-B    ((,c (:background ,grey-d :bold t))))
     `(ediff-fine-diff-C    ((,c (:background ,grey-d :bold t))))
     ...
     ;; evil-mode
     `(evil-ex-substitute-matches                   ((,c (:background ,black :foreground ,red :strike-through t :bold t))))
     `(evil-ex-substitute-replacement               ((,c (:background ,black :foreground ,green :bold t))))
     ;; evil-snipe
     `(evil-snipe-first-match-face ((,c (:foreground ,search-bg :background ,blue-d))))
     `(evil-snipe-matches-face     ((,c (:foreground ,search-bg :underline t :bold t))))
     ;; flycheck
     ...
     ;; iedit
     `(iedit-occurrence            ((,c (:foreground ,magenta :bold t :inverse-video t))))
     ...
     `(ivy-minibuffer-match-face-2 ((,c (:background ,black :foreground ,magenta :bold t))))
     `(ivy-minibuffer-match-face-3 ((,c (:background ,black :foreground ,green   :bold t))))
     `(ivy-minibuffer-match-face-4 ((,c (:background ,black :foreground ,yellow  :bold t))))
     ...
     `(tabbar-modified             ((,c (:inherit tabbar-default :foreground "#712222" :bold t))))
     `(tabbar-unselected           ((,c (:inherit tabbar-default :foreground ,modeline-fg-inactive))))
     `(tabbar-selected             ((,c (:inherit tabbar-default :foreground ,modeline-fg :background ,bg :bold t))))
     ...
     `(swiper-match-face-2         ((,c (:background ,orange  :foreground ,black :bold t))))
     `(swiper-match-face-3         ((,c (:background ,magenta :foreground ,black :bold t))))
     `(swiper-match-face-4         ((,c (:background ,green   :foreground ,black :bold t))))
     ;; stripe-buffer
     ...
     `(rainbow-delimiters-unmatched-face ((,c (:foreground ,red :bold t :inverse-video t))))
     ;; re-builder
     ...
     `(org-level-1               ((,c (:background ,current-line :foreground ,blue :bold t :height 1.2))))
