...
;;;;; basic coloring
   ...
   `(fringe ((t (:foreground ,pencil2 :background ,whisp4))))
...
;;;;; hl-line-mode
   `(hl-line-face ((,class (:background ,whisp4))
                   (t :weight bold)))
...
;;;;; hydra
   ...
   `(hydra-face-teal ((t (:foreground ,merged :background ,paper))))
;;;; ivy
   ...
   `(ivy-subdir ((t (:foreground ,marooned :background ,paper))))
...
;;;;; linum-mode
   `(linum ((t (:foreground ,pencil2 :background ,whisp4))))
;;;;; linum-relative-mode
...
;;;;;; references etc
   ...
   `(magit-refname        ((t (:background ,paper :foreground ,marooned :weight bold))))
   `(magit-refname-stash  ((t (:background ,paper :foreground ,marooned :weight bold))))
   `(magit-refname-wip    ((t (:background ,paper :foreground ,marooned :weight bold))))
